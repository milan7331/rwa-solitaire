...
export class UpdateUserDto {
    ...
    @MaxLength(64, { message: 'Current password cannot exceed 64 characters' })
    password?: string;
    ...
    @MaxLength(64, { message: 'firstname cannot exceed 64 characters' })
    ...
    @MaxLength(64, { message: 'lastname cannot exceed 64 characters' })
